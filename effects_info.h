...
//    Serial.print("Current p.x = ");Serial.println(p.x); //GOPAL TROUBLESHOOTING
//    Serial.print("Current p.y = ");Serial.println(p.y); //GOPAL TROUBLESHOOTING
//    //Serial.print("Current x = ");Serial.println(x); //GOPAL TROUBLESHOOTING
//    //Serial.print("Current y = ");Serial.println(y); //GOPAL TROUBLESHOOTING
//    Serial.print("CHORUSOFF_X = ");Serial.println(CHORUSOFF_X); //GOPAL TROUBLESHOOTING
//    Serial.print("CHORUSOFF_Y = ");Serial.println(CHORUSOFF_Y); //GOPAL TROUBLESHOOTING
//    Serial.print("CHORUSON_X = ");Serial.println(CHORUSON_X); //GOPAL TROUBLESHOOTING
//    Serial.print("CHORUSON_Y = ");Serial.println(CHORUSON_Y); //GOPAL TROUBLESHOOTING
//    Serial.print("CHORUSOFF_W = ");Serial.println(CHORUSOFF_W); //GOPAL TROUBLESHOOTING
//    Serial.print("CHORUSOFF_H = ");Serial.println(CHORUSOFF_H); //GOPAL TROUBLESHOOTING
//    Serial.print("CHORUSON_W = ");Serial.println(CHORUSON_W); //GOPAL TROUBLESHOOTING
//    Serial.print("CHORUSON_H = ");Serial.println(CHORUSON_H); //GOPAL TROUBLESHOOTING
//    Serial.print("tft.height() = ");Serial.println(tft.height());
//    Serial.print("tft.width() = ");Serial.println(tft.width());
//    Serial.print("CHORUSFRAME_X = ");Serial.println(CHORUSFRAME_X); //GOPAL TROUBLESHOOTING
//    Serial.print("CHORUSFRAME_Y = ");Serial.println(CHORUSFRAME_Y); //GOPAL TROUBLESHOOTING
//    Serial.print("FRAME_W = ");Serial.println(FRAME_W); //GOPAL TROUBLESHOOTING
//    Serial.print("FRAME_H = ");Serial.println(FRAME_H); //GOPAL TROUBLESHOOTING
//    Serial.println("");
//    Serial.println("");
